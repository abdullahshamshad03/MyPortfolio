...
export default function ExpandableCardDemo() {
  ...
  return (
    <motion.div initial={{opacity:0}} animate={{opacity:1, transition: {delay:0.5, duration: 0.6, ease: "easeInOut" }}} className="my-15">
      <AnimatePresence>
...
const cards = [
  ...
  },
  {
    ...
    title: "Insurance Premium Category",
    src: null,
    ctaText: null,
    ctaLink: null,
    content: () => {
